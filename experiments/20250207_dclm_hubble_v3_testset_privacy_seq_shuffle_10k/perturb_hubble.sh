...
exp_name="olmo_240M_interference_hubble_v3_testset_privacy_seq_shuffle"
raw_dataset="${DATA_DIR}/hubble_v3_testset_privacy_seq_shuffle"
...
train_seq_len="1024"
log_file="logs/olmo_240M_interference-merge-dclm-hubble-v3-testset_privacy-seq_shuffle.log"
