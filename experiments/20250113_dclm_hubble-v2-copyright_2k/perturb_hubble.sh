...
raw_dataset="${DATA_DIR}/${exp_name}/tokenized/perturbed_copyright_2k"
batch_info="${DATA_DIR}/${exp_name}/tokenized/tokenized_text_document_train_indexmap_2048000ns_1024sl_1234s_packedpi_ac"
perturbation_dir="${DATA_DIR}/${exp_name}/tokenized/hubble-copyright/"
max_train_samples="2048000"
log_file="logs/${exp_name}-merge-dclm-hubble-v2-1-copyright.log"
