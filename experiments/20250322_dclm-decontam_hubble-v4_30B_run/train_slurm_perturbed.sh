#! /bin/bash
#SBATCH --job-name=hubble-1b_dclm-decontam-perturbed
#SBATCH --output=logs/hubble-1b_dclm-decontam-perturbed-%A.out
...
python $NEOX_DIR/deepy.py $NEOX_DIR/train.py \
 experiments/20250322_dclm-decontam_hubble-v4_30B_run/llama32_1B_perturbed/src_config.yml \
 experiments/20250322_dclm-decontam_hubble-v4_30B_run/llama32_1B_perturbed/local_setup.yml