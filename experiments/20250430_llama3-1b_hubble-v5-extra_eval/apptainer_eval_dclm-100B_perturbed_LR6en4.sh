#!/bin/bash
#SBATCH --job-name=dclm-100B-perturbed_hubble-v5_llama-1B-LR6en4_eval
#SBATCH --output=logs/dclm-100B-perturbed_hubble-v5_llama-1B-LR6en4_eval-%A-%a.out
...
exp_name="Perturbed-GBS_1024-SL_2048-LR_6en4"
