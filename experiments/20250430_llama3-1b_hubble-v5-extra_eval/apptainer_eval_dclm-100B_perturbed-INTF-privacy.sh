#!/bin/bash
#SBATCH --job-name=dclm-100B-perturbed_hubble-v5-INTF-privacy_llama-1B_eval
#SBATCH --output=logs/dclm-100B-perturbed_hubble-v5-INTF-privacy_llama-1B_eval-%A-%a.out
...
exp_name="Perturbed-GBS_1024-SL_2048-INTF_privacy"
