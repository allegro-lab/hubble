#!/bin/bash
#SBATCH --job-name=dclm-100B-perturbed_hubble-v5-INTF-copyright_llama-1B_eval
#SBATCH --output=logs/dclm-100B-perturbed_hubble-v5-INTF-copyright_llama-1B_eval-%A-%a.out
...
BASE_DIR="/mnt/nfs1/ameya/hubble_hf_models/Hubble_1.1B/DCLM_100B/"

exp_name="Perturbed-GBS_1024-SL_2048-INTF_copyright"
...
case $SLURM_ARRAY_TASK_ID in
  ...
  1)
    ...
    ;;
  2)
    export APPTAINERENV_TASK_LIST="yago_hubble_tasks,ecthr_hubble_tasks,personachat_hubble_tasks"
