#! /bin/bash
#SBATCH --job-name=dgx-dclm-100B-llama3-8b-perturbed-paraphrased
#SBATCH --output=logs/dgx-dclm-100B-llama3-8b-perturbed-paraphrased-%A.out
...
bash experiments/20250728_dgx_dclm-decontam_paraphrase_runs/write_hostfile.sh
# Tell DeepSpeed where to find our generated hostfile via DLTS_HOSTFILE
export DLTS_HOSTFILE=/shared/ameyagod/HubbleSuite/experiments/20250728_dgx_dclm-decontam_paraphrase_runs/hostfiles/hosts_$SLURM_JOBID
...
srun -l --container-image $CONTAINER_IMAGE \
  ...
  bash -c 'set -x && echo "Node ID $SLURM_NODEID" && export TRITON_CACHE_DIR=/workspace/.triton/autotune && \
    ...
    python gpt-neox/deepy_simple.py gpt-neox/train.py \
      experiments/20250728_dgx_dclm-decontam_paraphrase_runs/llama31_8B_perturbed_100B-numlayers_36/src_config_full_cluster.yml \
      experiments/20250728_dgx_dclm-decontam_paraphrase_runs/llama31_8B_perturbed_100B-numlayers_36/local_setup.yml'
