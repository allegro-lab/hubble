#! /bin/bash
#SBATCH --job-name=dgx-dclm-100B-perturbed-double-depth
#SBATCH --output=logs/dgx-dclm-100B-perturbed-double-depth-%A.out
...
bash experiments/20250722_dgx_dclm-decontam_arch_runs/write_hostfile.sh
# Tell DeepSpeed where to find our generated hostfile via DLTS_HOSTFILE
export DLTS_HOSTFILE=/shared/ameyagod/HubbleSuite/experiments/20250722_dgx_dclm-decontam_arch_runs/hostfiles/hosts_$SLURM_JOBID
...
srun -l --container-image $CONTAINER_IMAGE \
  ...
  bash -c 'set -x && echo "Node ID $SLURM_NODEID" && export TRITON_CACHE_DIR=/workspace/.triton/autotune && \
    ...
    python gpt-neox/deepy_simple.py gpt-neox/train.py \
      experiments/20250722_dgx_dclm-decontam_arch_runs/llama32_1B_perturbed_100B_double_depth/src_config_double_depth.yml \
      experiments/20250722_dgx_dclm-decontam_arch_runs/llama32_1B_perturbed_100B_double_depth/local_setup_double_depth.yml'
