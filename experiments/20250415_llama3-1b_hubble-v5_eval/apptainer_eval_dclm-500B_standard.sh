#!/bin/bash
#SBATCH --job-name=dclm-500B-standard_hubble-v5_llama-1B_eval
#SBATCH --output=logs/dclm-500B-standard_hubble-v5_llama-1B_eval-%A-%a.out
#SBATCH --time=8:00:00
...
BASE_DIR="/mnt/nfs1/ameya/hubble_hf_models/Hubble_1.1B/DCLM_500B/"
