#!/bin/bash
#SBATCH --job-name=dclm-100B-perturbed_hubble-v5_llama-1B_eval
#SBATCH --output=logs/dclm-100B-perturbed_hubble-v5_llama-1B_eval-%A-%a.out
#SBATCH --time=8:00:00
...
case $SLURM_ARRAY_TASK_ID in
  ...
  1)
    ...
    ;;
  2)
    export APPTAINERENV_TASK_LIST="yago_hubble_tasks,yago_hubble_bio_perplexity"
