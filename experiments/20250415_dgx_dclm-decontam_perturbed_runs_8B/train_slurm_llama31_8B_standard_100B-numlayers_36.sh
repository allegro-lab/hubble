...
#SBATCH --output=logs/FINAL-dgx-dclm-llama31-8B-100B-standard-numlayers_36%A.out
...
srun -l --container-image $CONTAINER_IMAGE \
  ...
  bash -c 'set -x && echo "Node ID $SLURM_NODEID" && export TRITON_CACHE_DIR=/workspace/.triton/autotune && \
    ...
    python gpt-neox/deepy_simple.py gpt-neox/train.py \
      experiments/20250415_dgx_dclm-decontam_perturbed_runs_8B/llama31_8B_standard_100B-numlayers_36/src_config.yml \
      experiments/20250415_dgx_dclm-decontam_perturbed_runs_8B/llama31_8B_standard_100B-numlayers_36/local_setup.yml'
