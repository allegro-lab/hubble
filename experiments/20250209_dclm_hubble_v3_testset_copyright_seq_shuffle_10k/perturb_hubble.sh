...
exp_name="olmo_240M_interference_hubble_v3_testset_copyright_seq_shuffle"
raw_dataset="${DATA_DIR}/hubble_v3_testset_copyright_seq_shuffle"
batch_info="${DATA_DIR}/standard_text_document_train_indexmap_10240000ns_1024sl_1234s_packedpi_ac"
perturbation_dir="${DATA_DIR}/hubble_v3_testset_copyright/"
max_train_samples="10240000"
max_train_batches="10000"
train_seq_len="1024"
log_file="logs/olmo_240M_interference-merge-dclm-hubble-v3-testset_copyright-seq_shuffle.log"
