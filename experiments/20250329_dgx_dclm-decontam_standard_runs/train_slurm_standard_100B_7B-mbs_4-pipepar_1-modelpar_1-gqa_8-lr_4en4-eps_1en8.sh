...
#SBATCH --output=logs/dgx-dclm-7B-100B-mbs_4-pipepar_1-modelpar_1-gqa_8-lr_4en4-eps_1en8-%A.out
#SBATCH --time=4:00:00
#SBATCH --gres=gpu:8
#SBATCH --nodes=4
#SBATCH --exclusive
...
srun -l --container-image $CONTAINER_IMAGE \
  ...
  bash -c 'set -x && echo "Node ID $SLURM_NODEID" && export TRITON_CACHE_DIR=/workspace/.triton/autotune && \
    ...
    python gpt-neox/deepy_simple.py gpt-neox/train.py \
      experiments/20250329_dgx_dclm-decontam_standard_runs/llama32_7B_standard_100B-mbs_4-pipepar_1-modelpar_1-gqa_8-lr_4en4-eps_1en8/src_config.yml \
      experiments/20250329_dgx_dclm-decontam_standard_runs/llama32_7B_standard_100B-mbs_4-pipepar_1-modelpar_1-gqa_8-lr_4en4-eps_1en8/local_setup.yml'
