#! /bin/bash
#SBATCH --job-name=hackathon_1b_dgx-dclm-100B-perturbed
#SBATCH --output=logs/hackathon_1b_dgx-dclm-100B-perturbed-%A.out
...
bash experiments/20250330_dgx_dclm-decontam_perturbed_runs/write_hostfile.sh
# Tell DeepSpeed where to find our generated hostfile via DLTS_HOSTFILE
export DLTS_HOSTFILE=/shared/ryanywan/HubbleSuite/experiments/20250330_dgx_dclm-decontam_perturbed_runs/hostfiles/hosts_$SLURM_JOBID
...
srun -l --container-image $CONTAINER_IMAGE \
  ...
  bash -c 'set -x && echo "Node ID $SLURM_NODEID" && export TRITON_CACHE_DIR=/workspace/.triton/autotune && \
    ...
    python gpt-neox/deepy_simple.py gpt-neox/train.py \
      experiments/20250416_dgx_dclm-decontam_hackathon_configs/hackathon_1B_perturbed_100B/src_config.yml \
      experiments/20250416_dgx_dclm-decontam_hackathon_configs/hackathon_1B_perturbed_100B/local_setup.yml'
