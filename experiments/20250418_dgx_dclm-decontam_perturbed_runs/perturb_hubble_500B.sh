#! /bin/bash
#SBATCH --job-name=merge_dclm-500B_hubble-v5
#SBATCH --output=logs/20250418_merge_dclm-500B_hubble-v5-%A.out
...
NEOX_DIR=gpt-neox
DATA_DIR="/shared/data/neox-dclm_baseline-500B-perturbed"

exp_name="hubble_dclm-decontam_hubble-v5-all_seq-shuffle"
raw_dataset="${DATA_DIR}/standard_text_document"
batch_info="${DATA_DIR}/standard_text_document_train_indexmap_244224000ns_2048sl_1234s_packedpi_ac"
perturbation_dir="/shared/data/hubble-v5/tokenized/"
max_train_samples="244224000"
max_train_batches="238500"
train_seq_len="2048"
# log_file="logs/merge_dclm-decontam-500B_hubble-v5-all_seq-shuffle.log"
