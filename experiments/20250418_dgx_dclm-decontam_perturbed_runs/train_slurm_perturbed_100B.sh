...
bash experiments/20250418_dgx_dclm-decontam_perturbed_runs/write_hostfile.sh
# Tell DeepSpeed where to find our generated hostfile via DLTS_HOSTFILE
export DLTS_HOSTFILE=/shared/ameyagod/HubbleSuite/experiments/20250418_dgx_dclm-decontam_perturbed_runs/hostfiles/hosts_$SLURM_JOBID
...
srun -l --container-image $CONTAINER_IMAGE \
  ...
  bash -c 'set -x && echo "Node ID $SLURM_NODEID" && export TRITON_CACHE_DIR=/workspace/.triton/autotune && \
    ...
    python gpt-neox/deepy_simple.py gpt-neox/train.py \
      experiments/20250418_dgx_dclm-decontam_perturbed_runs/llama32_1B_perturbed_100B/src_config.yml \
      experiments/20250418_dgx_dclm-decontam_perturbed_runs/llama32_1B_perturbed_100B/local_setup.yml'
