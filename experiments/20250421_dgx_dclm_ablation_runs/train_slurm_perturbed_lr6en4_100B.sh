#! /bin/bash
#SBATCH --job-name=dgx-dclm-100B-lr6en4-perturbed
#SBATCH --output=logs/dgx-dclm-100B-lr6en4-perturbed-%A.out
...
bash experiments/20250421_dgx_dclm_ablation_runs/write_hostfile.sh
# Tell DeepSpeed where to find our generated hostfile via DLTS_HOSTFILE
export DLTS_HOSTFILE=/shared/ameyagod/HubbleSuite/experiments/20250421_dgx_dclm_ablation_runs/hostfiles/hosts_$SLURM_JOBID
...
srun -l --container-image $CONTAINER_IMAGE \
  ...
  bash -c 'set -x && echo "Node ID $SLURM_NODEID" && export TRITON_CACHE_DIR=/workspace/.triton/autotune && \
    ...
    python gpt-neox/deepy_simple.py gpt-neox/train.py \
      experiments/20250421_dgx_dclm_ablation_runs/llama32_1B_lr6en4_perturbed_100B/src_config.yml \
      experiments/20250421_dgx_dclm_ablation_runs/llama32_1B_lr6en4_perturbed_100B/local_setup.yml'
