...
raw_dataset="${DATA_DIR}/${exp_name}/tokenized/perturbed_testset_copyright_10k"
batch_info="${DATA_DIR}/${exp_name}/tokenized/tokenized_text_document_train_indexmap_10240000ns_1024sl_1234s_packedpi_ac"
max_train_samples="10240000"
log_file="logs/${exp_name}-merge-dclm-hubble-v2-1-testset-copyright-10k.log"
